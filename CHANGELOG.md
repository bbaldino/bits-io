...
## [0.6.4](https://github.com/bbaldino/bits-io/compare/v0.6.3...v0.6.4) - 2025-08-12

### Other

- *(deps)* bump actions/checkout from 4 to 5 ([#29](https://github.com/bbaldino/bits-io/pull/29))
# Changelog
All notable changes to this project will be documented in this file.
